...
public class UserActivity {
	...
	public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
		...
		else if(user.getUserRole() == UserRole.MODERATOR){questionService.deleteQuestion(question);}
		// Write else if condition to check if the user is a moderator
		else if(user.getUserRole() == UserRole.USER){questionService.deleteQuestion(question);}
		// Write else if condition to check if the user is a regular user
		else if(user == question.getUser()){questionService.deleteQuestion(question);}
        // Write else if condition to check if the user is also the user who wrote the question
